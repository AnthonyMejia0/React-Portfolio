        ...
        <div className="about" id="about">
            <div className="text-box">
                ...
                <div className="detailed">
                    ...
                    <p>Currently I am exploring Full-Stack Web Development by taking courses and building web clones. My latest project is a fully responsive Spotify Controller using Next.js, Tailwind CSS, NextAuth and the Spotify API. Check it out <a className="link" href="https://spotify-clone-xi-five.vercel.app/" target="_blank" rel="noreferrer">here.</a></p>
                </div>
